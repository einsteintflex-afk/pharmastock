-- 0001 BASELINE: the original PharmaStock schema (from db_schema.sql).
-- On an existing database this migration is STAMPED as applied, never run.
-- On a fresh database it creates the original seven tables.
