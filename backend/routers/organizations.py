...
def onboarding_status(user: CurrentUser = Depends(get_current_user), conn: psycopg.Connection = Depends(get_db)):
    ...
    steps = [
        ...
        ("locations", "Locations", "Pharmacy, store, wards or branches", "#/settings",
        ...
        ("opening_stock", "Opening stock", "Record the batches on your shelves (or run a stock count)", "#/inventory",
